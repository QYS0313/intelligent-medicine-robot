...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--collection-status", action="store_true", help="读取收药盒计数和是否收齐")
    parser.add_argument("--collection-reset", action="store_true", help="清空本次收药计数状态")
...
def main() -> None:
    ...
    if args.health:
    ...
    elif args.collection_status:
        result = request_json("GET", f"{base_url}/collection/status")
    elif args.collection_reset:
        result = request_json("POST", f"{base_url}/collection/reset", {})
    elif args.stop:
        ...
        raise SystemExit(
            ...
            "--collection-status、--collection-reset、"
